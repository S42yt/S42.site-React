...
const handleReactClick = () => {
  ...
  return (
    <div className={`readme ${isVisible ? 'visible' : ''}`}>
      ...
      <p><i>i stole from tamikaschu uwu</i></p>
      ...
      <p>
        ...
        <img src="https://img.shields.io/badge/react-%2320232a.svg?style=for-the-badge&logo=react&logoColor=%2361DAFB" alt="React" onClick={handleReactClick} style={{ cursor: 'pointer' }} />
      </p>
      ...
      <h2>📊 Stats:</h2>
      <p>
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=S42yt&theme=dark&hide_border=false&include_all_commits=false&count_private=false&layout=compact" alt="Top Languages" />
      </p>
      <hr />
